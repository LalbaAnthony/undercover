<template>
    <Bento title="Paramètres">
        <div class="flex flex-row flex-wrap flexitems-center gap-x-8 gap-y-4 mx-4">
            ...
            <div class="flex flex-row gap-2">
                <input v-model="undercoverStore.settings.canWhiteStart" id="canWhiteStart" name="canWhiteStart" type="checkbox" />
                <label for="canWhiteStart">Mister White peut commencer</label>
            </div>
            <div class="flex flex-row gap-2">
